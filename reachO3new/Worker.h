#ifndef WORKER_Ho3new
#define WORKER_Ho3new
/**
 * this version of code tries another version of O3, and has the following differencies:
 * 1. instead using std::map to store the visit status, using
 */
#include <vector>
#include <fstream>
